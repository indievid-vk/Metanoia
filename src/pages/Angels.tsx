        ...
        <div className="relative z-10 space-y-12">
          ...
          <section className="space-y-6">
            <div className="flex flex-col items-center gap-6">
              <h2 className="font-izhitsa text-2xl text-[var(--color-ink)] text-center">Слово об ангелах</h2>
              
              <DownloadButton 
                title="Слово об ангелах"
                downloadUrl={getAssetPath("/books/Slovo_ob_angelah.epub")}
                fileName="Slovo_ob_angelah.epub"
                className="max-w-md"
              />
          ...
          <section className="space-y-6">
            <div className="flex flex-col items-center gap-6">
              <h2 className="font-izhitsa text-2xl text-[var(--color-ink)] text-center">Слово о чувственном и о духовном видении духов</h2>
              
              <DownloadButton 
                title="Слово о чувственном и о духовном видении духов"
                downloadUrl={getAssetPath("/books/Slovo_o_duhah.epub")}
                fileName="Slovo_o_duhah.epub"
                className="max-w-md"
              />
