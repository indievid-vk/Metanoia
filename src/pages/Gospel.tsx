    ...
    <div className="space-y-6 px-4">
      <div className="grid gap-4 max-w-xl mx-auto">
        ...
        >
          ...
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">Оглашение</h3>
        ...
        >
          <div className="absolute top-0 right-0 w-16 h-16 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">Священное Писание</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
        ...
        >
          <div className="absolute top-0 right-0 w-16 h-16 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">Евангельские заповеди</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
        ...
        >
          <div className="absolute top-0 right-0 w-16 h-16 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">О смерти</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
        ...
        >
          <div className="absolute top-0 right-0 w-16 h-16 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">Об ангелах</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
        ...
        >
          <div className="absolute top-0 right-0 w-16 h-16 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-8 -mt-8 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2">Душеполезная литература</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
