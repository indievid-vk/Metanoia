  ...
  return (
    <div className="space-y-6 px-4">
      <div className="grid gap-4 max-w-xl mx-auto">
        ...
        <button 
          onClick={() => navigate('/gospel-life/dogmas')}
          className="bg-[var(--color-parchment)] border border-[var(--color-cinnabar)]/30 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-left group relative overflow-hidden border-l-4 border-l-[var(--color-cinnabar)]"
        >
          <div className="absolute top-2 right-2">
            <div className="bg-[var(--color-cinnabar)]/10 text-[var(--color-cinnabar)] text-[10px] px-3 py-1 rounded-full font-bold uppercase tracking-wider shadow-sm">Вера</div>
          </div>
          <div className="absolute top-0 right-0 w-20 h-20 bg-[var(--color-cinnabar)]/5 rounded-bl-full -mr-10 -mt-10 transition-transform group-hover:scale-150"></div>
          <h3 className="font-izhitsa text-xl text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-cinnabar)] transition-colors">Догматы богословия</h3>
          <p className="text-sm text-[var(--color-ink)]/70 leading-relaxed">
            Основополагающие, неизменные истины православного христианского вероучения.
          </p>
        </button>
