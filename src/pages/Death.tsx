    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12 px-4">
      <div className="pb-8">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <div className="mt-6 max-w-xl mx-auto">
            <DownloadButton 
              ...
              downloadUrl={getAssetPath("/books/slovo_o_smerti.epub")}
              fileName="slovo_o_smerti.epub"
            />
          </div>
        </div>
        ...
        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2">Разлучение души с телом</h3>
        ...
        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2">Первые три дня и воздушные мытарства</h3>
        ...
        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2">С 3-го по 9-й день</h3>
          <p className="leading-relaxed">
        ...
        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2">С 9-го по 40-й день и частный суд</h3>
          <p className="leading-relaxed">
        ...
        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2 text-red-800">Какие души идут в ад без прохождения мытарств</h3>
          <div className="space-y-4 leading-relaxed">
            <p>
            ...
            <ul className="space-y-3 list-disc list-inside">
              <li><span className="text-[var(--color-cinnabar)]">Неверующие и идолослужители:</span> Все чуждые Бога, магометане и не познавшие истины.</li>
              <li><span className="text-[var(--color-cinnabar)]">Еретики и отступники:</span> Искажавшие православную веру и умершие в заблуждении без раскаяния.</li>
              <li><span className="text-[var(--color-cinnabar)]">Христиане в смертных грехах:</span> Те, кто впал в смертные грехи и не уврачевал свою душу искренним покаянием до разлучения с телом.</li>
            </ul>
          </div>
        </section>

        <section className="bg-white/50 p-6 rounded-lg border border-[var(--color-ink)]/10 shadow-sm space-y-4">
          <h3 className="font-izhitsa text-xl text-[var(--color-cinnabar)] border-b border-[var(--color-cinnabar)]/10 pb-2">Помощь душам молитвами со стороны Церкви и родных</h3>
          <div className="space-y-4 leading-relaxed">
            <p>
            ...
            <p className="font-izhitsa text-lg text-[var(--color-cinnabar)]">Средства помощи:</p>
            <ol className="space-y-3 list-decimal list-inside">
              <li><span className="text-[var(--color-cinnabar)]">Бескровная Жертва (Божественная Литургия):</span> Самое сильное средство умилостивления Бога.</li>
              <li><span className="text-[var(--color-cinnabar)]">Молитвы Церкви и близких:</span> Искренняя молитва преклоняет милосердие Божие.</li>
              <li><span className="text-[var(--color-cinnabar)]">Милостыня и благотворения:</span> Дела милосердия в память об усопшем.</li>
            </ol>
