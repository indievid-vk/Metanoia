    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12 px-4">
      <div className="pb-8">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <div className="font-izhitsa text-[var(--color-ink)]/80 max-w-2xl mx-auto mb-6">
            Огласительные беседы об основных понятиях учения Православной Церкви.
          </div>

          <button 
            onClick={() => navigate('/gospel-life/catechesis/questions')}
            className="inline-flex items-center gap-2 px-8 py-3 bg-[var(--color-cinnabar)] text-[var(--color-parchment)] rounded-full font-izhitsa text-lg shadow-lg hover:shadow-xl hover:brightness-110 transition-all active:scale-95 mb-4"
          >
            Контрольные вопросы
          </button>
        </div>
          ...
          >
            ...
            <div className="w-full lg:w-2/5 space-y-4">
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-[var(--color-cinnabar)] text-white text-sm">
                  {index + 1}
                </span>
                <h2 className="text-2xl font-izhitsa text-[var(--color-ink)] leading-tight">
                  {video.title}
                </h2>
              </div>
