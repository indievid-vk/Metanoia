  ...
  return (
    <div className="space-y-6 pb-8">
      <div className="text-center mb-6 px-4">
        <h2 className="font-izhitsa text-2xl text-[var(--color-cinnabar)]">Молитвы ко Святому Причащению</h2>
        <DecorativeDivider className="mt-4" />
        <div className="flex justify-center mt-4">
          <button 
            onClick={() => navigate('/prayer-book/communion/warning')}
            className="px-6 py-2 bg-[var(--color-parchment)] border border-[var(--color-cinnabar)] text-[var(--color-cinnabar)] rounded-lg font-izhitsa text-lg shadow-sm hover:shadow-md transition-shadow"
          >
      ...
      <div className="grid gap-3 px-4 max-w-xl mx-auto">
        {[
          ...
          >
            <span className="font-izhitsa text-lg text-[var(--color-ink)]">{item.title}</span>
          </button>
        ))}
      </div>
    </div>
