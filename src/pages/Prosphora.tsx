...
import { Info, AlertCircle, CheckCircle2, Maximize2, Minimize2, X } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12 px-4">
      <div className="pb-8">
        ...
        <div className="text-center mb-8 relative">
          <h1 className="font-izhitsa text-3xl sm:text-5xl text-[var(--color-cinnabar)] mb-4">
            О просфорах
          </h1>
          <DecorativeDivider className="mb-4" />
          <p className="font-izhitsa text-[var(--color-ink)]/80 max-w-2xl mx-auto">
        ...
        <div className="space-y-10 text-[var(--color-ink)]">
          ...
          <section className="space-y-4">
            ...
            <div className="font-izhitsa leading-relaxed space-y-4">
              <p>
                Просфора́ (от греч. «приношение») — это особый богослужебный хлеб, используемый в таинстве Евхаристии (Причащения) и для поминовения живых и усопших на Проскомидии. Своим происхождением она уходит в раннехристианские времена, когда верующие сами приносили из дома хлеб и вино для Литургии и последующих совместных трапез любви (агап).
              </p>
              <p>
                Просфора выпекается исключительно из квасного теста (пшеничная мука, вода, соль и закваска/дрожжи) с добавлением святой воды. Она состоит из двух частей, выпекаемых раздельно, а затем соединяемых, что символизирует два естества Иисуса Христа — Божественное и человеческое.
              </p>
              <p>
                На верхней части ставится круглая печать с равноконечным крестом и греческой надписью IC XC NIKA («Иисус Христос Победитель») или изображением Богородицы и святых. 
              </p>
            </div>
          </section>

          <section className="space-y-4">
            <h2 className="font-izhitsa text-2xl text-[var(--color-cinnabar)]">Служебные и поминальные просфоры</h2>
            <div className="flex flex-col sm:flex-row gap-4 mb-4">
              ...
              >
                ...
                <img src={getAssetPath("/images/Prosfora_collage.webp")} alt="Виды просфор" className="w-full h-full rounded-lg object-contain shadow-sm border border-[var(--color-ink)]/10 bg-white/50 p-1" />
              </div>
              <div 
                className="sm:w-1/2 w-full relative cursor-pointer group"
              ...
              >
                ...
                <img src={getAssetPath("/images/prosfori_proskomidiya1.webp")} alt="Просфоры на проскомидии" className="w-full h-full rounded-lg object-contain shadow-sm border border-[var(--color-ink)]/10 bg-white/50 p-1" />
              </div>
            </div>
            <div className="font-izhitsa leading-relaxed space-y-4 bg-white/40 p-5 rounded-lg border border-[var(--color-cinnabar)]/10">
              <p>Для совершения Божественной литургии (на Проскомидии) священником используются пять особых больших служебных просфор:</p>
          ...
          <section className="space-y-4">
            ...
            <div className="font-izhitsa leading-relaxed space-y-4">
              ...
              <p>
                Артос хранится в домах верующих весь год как великая святыня. Его вкушают (обычно смешав с богоявленской святой водой) в случаях тяжелых болезней, духовной скорби или сильных искушений со словами радости: Христос Воскресе! — Воистину Воскресе!.
              </p>
            </div>
            <div className="clear-both"></div>
          </section>
          ...
          <section className="space-y-6 pt-4">
            <h2 className="font-izhitsa text-2xl text-[var(--color-cinnabar)] text-center">
              Сравнение просфор
            </h2>
            <div className="overflow-x-auto rounded-lg border border-[var(--color-ink)]/10 font-izhitsa shadow-sm">
              <table className="min-w-full text-left text-sm">
                <thead className="bg-[#e8dfcf] text-[var(--color-ink)] font-normal">
                  <tr>
                    <th className="p-4 border-b border-[var(--color-ink)]/10 w-1/4">Просфора</th>
                    <th className="p-4 border-b border-[var(--color-ink)]/10">Происхождение и суть</th>
                    <th className="p-4 border-b border-[var(--color-ink)]/10">Как и когда употреблять</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[var(--color-ink)]/5 bg-white/40">
                  <tr className="hover:bg-white/60 transition-colors">
                    <td className="p-4 text-[var(--color-cinnabar)] align-top">
                      Служебные просфоры
                    </td>
                  ...
                  <tr className="bg-[var(--color-parchment)]/30 hover:bg-white/60 transition-colors">
                    ...
                    <td className="p-4 align-top text-sm leading-relaxed">
                      Раздается после окончания службы за свечным ящиком. Как правило, её уносят домой, нарезают и кушают утром натощак со святой водой и специальной молитвой на принятие святыни.
                    </td>
                  </tr>
                  <tr className="bg-[var(--color-parchment)]/30 hover:bg-white/60 transition-colors">
                    <td className="p-4 text-[var(--color-cinnabar)] align-top">
                    ...
                    <td className="p-4 align-top text-sm leading-relaxed">
                      Раздается в храме в конце службы после целования креста. Принимают в храме, на сложенные крестом ладони (правая поверх левой), целуя руку дающего. Потребляют сразу на ходу натощак, следя, чтобы не уронить крошки.
                    </td>
                  </tr>
                  <tr className="hover:bg-white/60 transition-colors">
                    <td className="p-4 text-[var(--color-cinnabar)] align-top">
                    ...
                    <td className="p-4 align-top text-sm leading-relaxed">
                      Раздается один раз в году — в Светлую Субботу (субботу после Пасхи). Хранится весь год, употребляется понемногу натощак (можно размочить в святой воде) при болезнях и скорбях со словами Христом Воскресе!.
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="grid sm:grid-cols-2 gap-6 pt-6">
            <section className="bg-white/60 p-6 rounded-lg border border-green-600/20 space-y-4">
              <h2 className="font-izhitsa text-xl text-green-700 flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5" /> Как правильно хранить
              </h2>
              <ul className="list-inside space-y-3 font-izhitsa text-[var(--color-ink)]/90 text-sm">
                ...
                <li className="flex gap-2 items-start">
                  <span className="text-green-600/70 shrink-0 mt-0.5">•</span> 
                  <span>Чтобы сохранить святыню надолго, её следует сразу нарезать на мелкие кусочки и высушить в сухарики. Резать нужно на чистом листе белой бумаги, чтобы не обронить ни одной святой крошки. Сухарики хранят в сухом месте в полотняном мешочке или бумажной коробке (не в целлофане, чтобы не задохнулись).</span>
                </li>
              </ul>
            </section>

            <section className="bg-[var(--color-cinnabar)]/5 p-6 rounded-lg border border-[var(--color-cinnabar)]/20 space-y-4">
              <h2 className="font-izhitsa text-xl text-[var(--color-cinnabar)] flex items-center gap-2">
                <AlertCircle className="w-5 h-5" /> Если просфора испортилась
              </h2>
              <div className="font-izhitsa leading-relaxed text-[var(--color-ink)]/90 text-sm space-y-4">
                <p>
                  Категорически не допускается выбрасывать испорченную, заплесневевшую просфору в мусорное ведро, канализацию, или скармливать ее домашним/уличным животным или птицам! Это является грехом небрежения к святыне.
                </p>
                <p>Если хлеб все же испортился, его утилизируют непопираемым способом:</p>
                <ul className="list-disc list-inside pl-1 space-y-2">
                  <li>Отнести в храм. В большинстве храмов есть специальные жаровни или печи для сжигания святынь.</li>
                  <li>Сжечь самостоятельно. Пепел от сожжения нельзя выбрасывать в ведро. Его нужно высыпать в проточную реку или закопать в чистом месте.</li>
                  <li>Бросить в реку. Обязательно в текущую (проточную) воду, привязав к святыне или мешочку камешек, чтобы хлеб опустился на дно и не был выброшен на грязный берег.</li>
                  <li>Закопать в непопираемом месте. Там, где не ходят люди и животные (например, глубоко под деревом в саду).</li>
                </ul>
              </div>
            </section>
          </div>
